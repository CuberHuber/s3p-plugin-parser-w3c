...
class TestPayloadRun:
    ...
    def test_run_with_10_docs_restriction(self, chrome_driver, fix_s3pRefer, fix_payload, fix_s3pPlugin):
        # !WARNING Обновить тест для актуального парсера
        max_docs = 10
        docs = self.run_payload(fix_payload, fix_s3pPlugin, chrome_driver, fix_s3pRefer, max_docs, 200)
